            ...
            <div className="flex justify-center">
              <form action="#" method="POST" className="space-y-4 border-none w-[350px]">
                ...
                <div>
                  <Link
                    to="/tokeninput"
                    className="flex w-full h-[48px] justify-center rounded-md bg-[#413FA0] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#413FA0] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 items-center"
                    data-aos="fade-down"
                  >
                    Recovery token
                  </Link>
