...
export default function Cards({ data }) {
  return (
    ...
    <div className="bg-white shadow-md rounded-md p-3 hide-scrollbar">
      <div className="flex flex-col space-y-4 min-w-full">
        {data.map((item, index) => (
          <div key={index} className="flex items-center space-x-2 w-full whitespace-nowrap">
            <input
              type="checkbox"
            ...
            <div className="flex-1 text-gray-600 font-semibold text-sm leading-5 flex items-center">
              <img src={Bee} alt="Bee Icon" className="h-6 w-6   " />
